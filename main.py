...
hyp = {
    'opt': {
        ...
        'warmup_steps': 0,       # For training stability in the main body of the network. (#TODO: Investigate the warmup imact a bit more)
    },
    'net': {
...
def main():
    ...
    scheduler         = TokenBasedLambdaLR(opt, [k['scheduler'] for k in param_groups_dict.values()])
